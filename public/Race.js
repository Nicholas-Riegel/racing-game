...
class Race {
    ...
    start() {
        ...
        this.checkCollisionsInterval = setInterval(() => CollisionDetector.checkCollisions(this.playerCar.getPlayerCarDivElement().getBoundingClientRect(), () => this.stop(), this.playerCar), 10);
    }
    stop() {
