...
let playerCarX: number;
let playerCarY: number;
...
let [arrowUp, arrowDown, arrowLeft, arrowRight]: boolean[] = [false, false, false, false]

// game boundaries
// Top: 4px from top of road, Bottom: 660px from top of road
// Left: 2px from left of road, Right: 428px from left of road
const topBoundry: number = 4;
const bottomBoundry: number = 660;
const leftBoundry: number = 2;
const rightBoundry: number = 428;
